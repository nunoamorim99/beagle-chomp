...
const ENEMY_ICONS: Record<string, string> = {
  ...
  bee: "hive",
  ladybug: "bug_report",
  // NO ENTRY FOR THE FLEA OR THE CRAB, deliberately. A fifth or sixth glyph
  ...
  // until the subset is re-cut; `pest_control` was the obvious candidate for the
  // flea but the beetle already wears it, and two skins sharing one picture reads
  // worse than the generic face does. The crab has no near-miss candidate at all
  // in the 46 names the subset holds.
};
